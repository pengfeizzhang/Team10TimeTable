<form action="add.php" method="post" enctype="multipart/form-data">
    ...
    <tr><td>Background Colour:</td><td><input type="text" name="bgcolour" value="" placeholder="" size="20"></td></tr>
    </table>
...
<?php
    ...
    if (isset($_POST['first']))
    {
        ...
        $sql = "INSERT INTO users (firstname, lastname, country, avatar, bgcolour) VALUES ('$firstname', '$lastname', '$country', 'img/$avatar.jpg', '$bgcolour')";
