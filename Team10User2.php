...
<body style="background-color:#FEE8D6;">
	<h1 id="title">Welcome User 2</h1> 
	...
	<table id="scheduleTable">
		...
		<tr>
			<th>Period 1</th>
			<td><div id="periodOne" ondrop="drop(event)" ondragover="allowDrop(event)"> </div>
			Description:  <input type="text" value=""/>
		</td>
		</tr>
		<tr>
			<th>Period 2</th>
			<td><div id="periodTwo" ondrop="drop(event)" ondragover="allowDrop(event)"> </div>
			Description:  <input type="text" value=""/>
		</td>
		</tr>
		<tr>
			<th>Lunch</th>
			<td><div id="lunch" ondrop="drop(event)" ondragover="allowDrop(event)"> </div>
			Description:  <input type="text" value=""/>
		</td>
		</tr>
		<tr>
			<th>Period 3</th>
			<td><div id="periodThree" ondrop="drop(event)" ondragover="allowDrop(event)"> </div>
			Description:  <input type="text" value=""/>
		</td>
		</tr>
		<tr>
			<th>Period 4</th>
			<td><div id="periodFour" ondrop="drop(event)" ondragover="allowDrop(event)"> </div>
			Description:  <input type="text" value=""/>
		</td>
